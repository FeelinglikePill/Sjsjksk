...
gui.Parent = workspace -- ❗ ต้องเป็น Workspace  
...
data.Gui.StudsOffset = Vector3.new(0, -3.5, 0) -- ใต้เท้าแบบนิ่ง  
...
-- Update ตลอด แก้ปัญหาอาวุธมาใหม่ไม่ขึ้น
RunService.RenderStepped:Connect(function()
...
PlayerTab:Toggle({
    Title = "Anti Ragdoll",
    Description = "Prevent falling & ragdoll",
    Default = false,
    Callback = function(v)
